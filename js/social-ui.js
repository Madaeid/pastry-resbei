...
export function createPostCard(post) {
    ...
    card.innerHTML = `
        <div class="post-header">
            <div class="post-author-info" style="cursor: pointer;" onclick="window.location.href=(window.location.pathname.includes('/pages/') ? './' : './pages/') + 'chef-profile.html?username=${post.author?.username || post.authorUsername}'">
    ...
    if (commentsListEl) {
        ...
        commentsListEl.addEventListener('click', (e) => {
            ...
            if (authorLink) {
                ...
                if (username) {
                    window.location.href = (window.location.pathname.includes('/pages/') ? './' : './pages/') + `chef-profile.html?username=${username}`;
                }
            }
