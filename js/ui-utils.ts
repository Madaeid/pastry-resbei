...
export function showNotification(message: string, optionsOrType?: NotificationType | NotificationOptions): void {
    ...
    // Event listeners
    if (action) {
        const actionBtn = notification.querySelector('.notification-action-btn') as HTMLButtonElement;
    ...
    const closeBtn = notification.querySelector('.notification-close-btn') as HTMLButtonElement;
